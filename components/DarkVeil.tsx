...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    const io = new IntersectionObserver((entries) => {
      for (const e of entries) {
        runningRef.current = e.isIntersecting && document.visibilityState === 'visible';
      }
  ...
  }, [hueShift, noiseIntensity, scanlineIntensity, speed, scanlineFrequency, warpAmount, resolutionScale, dprMax]);
